                         ...
                         Index& nnz_h_lag, IndexStyleEnum& index_style)
{
  ...
  n = 6*(int)my_pol.edges_list.size()+4*(int)my_pol.facets_list.size();
                            ...
                            Index m, Number* g_l, Number* g_u)
{
  ...
  assert(n == 6*(int)my_pol.edges_list.size()+4*(int)my_pol.facets_list.size());
                               ...
                               Number* lambda)
{
  ...
  {
      x[i*6+0]=my_pol.points_list[my_pol.edges_list[i].coord[0]].x;
      x[i*6+1]=my_pol.points_list[my_pol.edges_list[i].coord[0]].y;
      x[i*6+2]=my_pol.points_list[my_pol.edges_list[i].coord[0]].z;

      x[i*6+3]=my_pol.points_list[my_pol.edges_list[i].coord[1]].x;
      x[i*6+4]=my_pol.points_list[my_pol.edges_list[i].coord[1]].y;
      x[i*6+5]=my_pol.points_list[my_pol.edges_list[i].coord[1]].z;
  }
  int planes_index_start=6*(int)my_pol.edges_list.size();
                              ...
                              IpoptCalculatedQuantities* ip_cq)
{
    ...
    int planes_index_start=planes_index_start=6*(int)my_pol.edges_list.size();
...
void construct_model()
{
    ...
    for(int i=0;i<(int)points_for_edges[0].size();i++)
    {
        ...
        tec_point1=my_pol.points_list[my_pol.edges_list[i].coord[0]];
        tec_point2=my_pol.points_list[my_pol.edges_list[i].coord[1]];
